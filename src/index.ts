...
function spectrum(element: HTMLElement, options: Partial<SpectrumOptions>) {
  ...
  let body = doc.body,
    ...
    disabled = false,
    pickerContainer = container.querySelector<HTMLElement>('.sp-picker-container')!,
    dragger = container.querySelector<HTMLElement>('.sp-color')!,
    dragHelper = container.querySelector<HTMLElement>('.sp-dragger')!,
    slider = container.querySelector<HTMLElement>('.sp-hue')!,
    slideHelper = container.querySelector<HTMLElement>('.sp-slider')!,
    alphaSliderInner = container.querySelector<HTMLElement>('.sp-alpha-inner')!,
    alphaSlider = container.querySelector<HTMLElement>('.sp-alpha')!,
    alphaSlideHelper = container.querySelector<HTMLElement>('.sp-alpha-handle')!,
    textInput = container.querySelector<HTMLInputElement>('.sp-input')!,
    paletteContainer = container.querySelector<HTMLElement>('.sp-palette')!,
    initialColorContainer = container.querySelector<HTMLElement>('.sp-initial')!,
    cancelButton = container.querySelector<HTMLElement>('.sp-cancel')!,
    clearButton = container.querySelector<HTMLElement>('.sp-clear')!,
    chooseButton = container.querySelector<HTMLElement>('.sp-choose')!,
    toggleButton = container.querySelector<HTMLElement>('.sp-palette-toggle')!,
    ...
    previewElement = replacer?.querySelector<HTMLElement>('.sp-preview-inner')!,
