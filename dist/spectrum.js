...
/* harmony export */   "outerWidthWithMargin": () => (/* binding */ outerWidthWithMargin),
...
function insertBefore(existingNode, newNode) {
  var _a;
  (_a = existingNode.parentNode) === null || _a === void 0 ? void 0 : _a.insertBefore(newNode, existingNode);
  return existingNode;
}
...
/* harmony export */   "setElementOffset": () => (/* binding */ setElementOffset),
/* harmony export */   "throttle": () => (/* binding */ throttle),
/* harmony export */   "toggleClass": () => (/* binding */ toggleClass)
/* harmony export */ });
/* unused harmony exports camelize, getElementPosition */
/**
 * Part of spectrum-vanilla project.
 *
 * @copyright  Copyright (C) 2023 __ORGANIZATION__.
...
function index(element, options) {
  ...
  function getUniqueSelectionPalette() {
    ...
    if (opts.showPalette) {
      for (var i = 0; i < selectionPalette.length; i++) {
        var rgb = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_0__["default"])(selectionPalette[i]).toRgbString();
  ...
  function set(color) {
    ...
    if ((!color || color === undefined) && allowEmpty) {
      ...
      isEmpty = false;
      newColor = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_0__["default"])(color);
  ...
  function get() {
    ...
    return tinycolor2__WEBPACK_IMPORTED_MODULE_0__["default"].fromRatio({
      h: currentHue,
      s: currentSaturation,
      v: currentValue,
